...
<div style="text-align: center;">
  <img src="figures/terminal1.png" style="width: 100%;" />
</div>

## Where to run Python: *terminal / bash*

<div style="text-align: center;">
  <img src="figures/terminal2.png" style="width: 100%;" />
</div>
...
- <a href="https://code.visualstudio.com/" target="_blank">***Visual Studio (VS) Code***</a>: Full general-purpose, language agnostic code editor, maybe the most used environment for Python today; by Microsoft, but free
...
- <a href="https://jupyter.org/" target="_blank">***Jupyter Notebook***</a>: ideal for reports and markdown; very similar to Colab but run locally; enhanced IDE-like version: <a href="https://jupyterlab.readthedocs.io/en/latest/" target="_blank">***JupyterLab***</a>; free
