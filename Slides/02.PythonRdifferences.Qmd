...
But in Python you can use the built-in function `append()`:
```{python, error = T}
grades.append("K")
grades
```
...
In *Python*, you may even multiply a single string:
...
To obtain vectorized operations like those of R, you need to import **`numpy`**
...
## Key differences: COERCING TYPES
