...
-   Run a pretrained model to perform sentiment analysis on the review texts;
-   Assess prediction accuracy (i.e., how well the model prediction actually matches the customer stars ⭐);
-   Plot the logistic relationship between model predictions and customer ratings.
...
Now, this is a bit technical: instead of relying on the `pipeline`, we need to separately *tokenize* the sentence and apply the *model*
