...
``` csharp
my_project/
├── venv/         ← <span style="color:#b600b6;">virtual environment</span> (excluded <span style="color:#b600b6;">from</span> Git)
├── data/         ← raw .csv, .xlsx, etc.
├── notebooks/    ← Jupyter <span style="color:#ff5f5f;">or</span> Colab notebooks
├── scripts/      ← your Python scripts
├── results/      ← output files, figures
├── requirements.txt ← list of installed <span style="color:#368ad1;">packages</span> (<span style="color:#b600b6;">for</span> reproducibility)
└── README.md     ← <span style="color:#e6b800;">short</span> description of the project
```
