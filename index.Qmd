...
-   [**Basics of Text Classification using Embeddings and Cosine Similarity**](exercises/Exercises-EmbeddingsCosineSim.html){target="_blank"}
    -   ::: {style="font-size:14px;"}
        **additional exercise on [Using text embeddings to automatically evaluate construct validity](exercises/ExercisesExtra-Questionnaires.html){target="_blank"}**
        :::
...
<span style="font-size: 12px;">Read a modest proposal for <a href="https://docs.google.com/document/d/1-2Ty2Sd1QQzCCFt3SZpz3hhRkM3XEdvf/" target="_blank">open source software in the PhD program in Psychological Sciences</span>
  <img src="figures/qrcode_manifesto_opensource.png" style="height: 50px;">
  </div>
