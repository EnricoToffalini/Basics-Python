...
This is an introductory course on <a href="https://www.python.org/" target=_blank>**Python**</a> that is offered within the <a href="https://dottorato.psy.unipd.it/en" target="_blank">PhD program in Psychological Sciences</a> *(University of Padova)*. While R is more extensively used for statistical analysis and data science in this PhD program, familiarity with Python is useful for different purposes, including advanced machine learning application, deep learning models, natural language processing, computational efficiency in some scenarios, and programming experiments. Also, Python is widely required in industry and business, so basic proficiency with it a valuable asset! There are no prerequisites, but having attended <a href="https://enricotoffalini.github.io/Basics-R/" target="_blank">*Basics of R for Data Science*</a> may greatly help (and, well, it was a mandatory course for our PhD students).
...
1.  **Install Python** locally: go to the official <a href="https://www.python.org/downloads/" target="_blank">Python download page</a> and follow the installation instructions for your operating system.
